    ...
    const summaries: RevisionSessionSummary[] = [
      {
        ...
        totalQuestions: 10,
        correctCount: 8,
        breakdownByCategory: { muscle: { total: 10, correct: 8 }, bone: { total: 0, correct: 0 }, landmark: { total: 0, correct: 0 } },
        breakdownByRegion: {},
        missedStructureIds: [],
      },
      {
        ...
        totalQuestions: 10,
        correctCount: 9,
        breakdownByCategory: { muscle: { total: 10, correct: 9 }, bone: { total: 0, correct: 0 }, landmark: { total: 0, correct: 0 } },
        breakdownByRegion: {},
        missedStructureIds: [],
      },
    ];
