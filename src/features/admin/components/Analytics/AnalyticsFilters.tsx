...
import { CATEGORIES, type Category } from '../../../anatomy-revision/types/structure';
...
const CATEGORY_LABELS: Record<Category, string> = { muscle: 'Muscle', bone: 'Bone', landmark: 'Landmark', joint: 'Joint', ligament: 'Ligament' };
