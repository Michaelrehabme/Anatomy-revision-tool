...
export const JOINT_PANELS: JointPanel[] = [
  ...
  { structureId: 'atlanto-occipital-joint', name: "Atlanto-occipital Joint", region: 'back-core', subregion: 'neck', view: 'lateral', width: 1400, height: 1400 },
  { structureId: 'atlanto-occipital-joint', name: "Atlanto-occipital Joint", region: 'back-core', subregion: 'neck', view: 'posterior', width: 1400, height: 1400 },
  ...
  { structureId: 'carpometacarpal-joint-2', name: "Second Carpometacarpal Joint", region: 'forearm-hand', subregion: 'wrist-hand', view: 'anterior', width: 1400, height: 1400 },
  { structureId: 'carpometacarpal-joint-2', name: "Second Carpometacarpal Joint", region: 'forearm-hand', subregion: 'wrist-hand', view: 'posterior', width: 1400, height: 1400 },
  { structureId: 'carpometacarpal-joint-3', name: "Third Carpometacarpal Joint", region: 'forearm-hand', subregion: 'wrist-hand', view: 'anterior', width: 1400, height: 1400 },
  { structureId: 'carpometacarpal-joint-3', name: "Third Carpometacarpal Joint", region: 'forearm-hand', subregion: 'wrist-hand', view: 'posterior', width: 1400, height: 1400 },
  { structureId: 'carpometacarpal-joint-4', name: "Fourth Carpometacarpal Joint", region: 'forearm-hand', subregion: 'wrist-hand', view: 'anterior', width: 1400, height: 1400 },
  { structureId: 'carpometacarpal-joint-4', name: "Fourth Carpometacarpal Joint", region: 'forearm-hand', subregion: 'wrist-hand', view: 'posterior', width: 1400, height: 1400 },
  { structureId: 'carpometacarpal-joint-5', name: "Fifth Carpometacarpal Joint", region: 'forearm-hand', subregion: 'wrist-hand', view: 'anterior', width: 1400, height: 1400 },
  { structureId: 'carpometacarpal-joint-5', name: "Fifth Carpometacarpal Joint", region: 'forearm-hand', subregion: 'wrist-hand', view: 'posterior', width: 1400, height: 1400 },
  ...
  { structureId: 'facet-joint', name: "Facet (Zygapophyseal) Joint", region: 'back-core', subregion: 'spine', view: 'anterior', width: 1400, height: 1400 },
  { structureId: 'facet-joint', name: "Facet (Zygapophyseal) Joint", region: 'back-core', subregion: 'spine', view: 'posterior', width: 1400, height: 1400 },
  ...
  { structureId: 'hip-joint', name: "Hip Joint", region: 'hip-thigh', subregion: 'hip', view: 'anterior', width: 1400, height: 1400 },
  { structureId: 'hip-joint', name: "Hip Joint", region: 'hip-thigh', subregion: 'hip', view: 'posterior', width: 1400, height: 1400 },
  ...
  { structureId: 'interphalangeal-joint-hand', name: "Interphalangeal Joint of the Hand", region: 'forearm-hand', subregion: 'wrist-hand', view: 'anterior', width: 1400, height: 1400 },
  { structureId: 'interphalangeal-joint-hand', name: "Interphalangeal Joint of the Hand", region: 'forearm-hand', subregion: 'wrist-hand', view: 'posterior', width: 1400, height: 1400 },
  { structureId: 'intervertebral-joint', name: "Intervertebral Joint", region: 'back-core', subregion: 'spine', view: 'anterior', width: 1400, height: 1400 },
  { structureId: 'intervertebral-joint', name: "Intervertebral Joint", region: 'back-core', subregion: 'spine', view: 'lateral', width: 1400, height: 1400 },
  { structureId: 'intervertebral-joint', name: "Intervertebral Joint", region: 'back-core', subregion: 'spine', view: 'posterior', width: 1400, height: 1400 },
  ...
  { structureId: 'midcarpal-joint', name: "Midcarpal Joint", region: 'forearm-hand', subregion: 'wrist-hand', view: 'anterior', width: 1400, height: 1400 },
  { structureId: 'midcarpal-joint', name: "Midcarpal Joint", region: 'forearm-hand', subregion: 'wrist-hand', view: 'posterior', width: 1400, height: 1400 },
  ...
  { structureId: 'pubic-symphysis', name: "Pubic Symphysis", region: 'hip-thigh', subregion: 'hip', view: 'anterior', width: 1400, height: 1400 },
  { structureId: 'pubic-symphysis', name: "Pubic Symphysis", region: 'hip-thigh', subregion: 'hip', view: 'lateral', width: 1400, height: 1400 },
  ...
  { structureId: 'sacroiliac-joint', name: "Sacroiliac Joint", region: 'back-core', subregion: 'spine', view: 'anterior', width: 1400, height: 1400 },
  { structureId: 'sacroiliac-joint', name: "Sacroiliac Joint", region: 'back-core', subregion: 'spine', view: 'lateral', width: 1400, height: 1400 },
  { structureId: 'sacroiliac-joint', name: "Sacroiliac Joint", region: 'back-core', subregion: 'spine', view: 'posterior', width: 1400, height: 1400 },
  { structureId: 'sternoclavicular-joint', name: "Sternoclavicular Joint", region: 'shoulder-arm', subregion: 'shoulder', view: 'anterior', width: 1400, height: 1400 },
  { structureId: 'sternoclavicular-joint', name: "Sternoclavicular Joint", region: 'shoulder-arm', subregion: 'shoulder', view: 'lateral', width: 1400, height: 1400 },
  { structureId: 'sternoclavicular-joint', name: "Sternoclavicular Joint", region: 'shoulder-arm', subregion: 'shoulder', view: 'posterior', width: 1400, height: 1400 },
  { structureId: 'sternocostal-joint', name: "Sternocostal Joint", region: 'back-core', subregion: 'torso', view: 'anterior', width: 1400, height: 1400 },
  { structureId: 'sternocostal-joint', name: "Sternocostal Joint", region: 'back-core', subregion: 'torso', view: 'lateral', width: 1400, height: 1400 },
  { structureId: 'sternocostal-joint', name: "Sternocostal Joint", region: 'back-core', subregion: 'torso', view: 'posterior', width: 1400, height: 1400 },
  ...
  { structureId: 'talocrural-joint', name: "Talocrural Joint", region: 'lower-leg-foot', subregion: 'ankle-foot', view: 'anterior', width: 1400, height: 1400 },
  { structureId: 'talocrural-joint', name: "Talocrural Joint", region: 'lower-leg-foot', subregion: 'ankle-foot', view: 'posterior', width: 1400, height: 1400 },
  ...
  { structureId: 'transverse-tarsal-joint', name: "Transverse Tarsal Joint", region: 'lower-leg-foot', subregion: 'ankle-foot', view: 'anterior', width: 1400, height: 1400 },
  { structureId: 'transverse-tarsal-joint', name: "Transverse Tarsal Joint", region: 'lower-leg-foot', subregion: 'ankle-foot', view: 'posterior', width: 1400, height: 1400 },
];
