...
export const ACCEPTED_LARGE: Record<string, { maxArea: number; why: string }> = {
  ...
  'ligament-external-intercostal-membrane-a000-context': { maxArea: 0.12, why: 'the membrane fills every intercostal space in view, both sides; its outline is the sheet' },
  'ligament-external-intercostal-membrane-a045-context': { maxArea: 0.12, why: 'the membrane fills every intercostal space in view, both sides; its outline is the sheet' },
  'ligament-external-intercostal-membrane-a315-context': { maxArea: 0.12, why: 'the membrane fills every intercostal space in view, both sides; its outline is the sheet' },
};
