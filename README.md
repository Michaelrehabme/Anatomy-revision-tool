...
On first run you'll get a large, immediately-usable content library: 457 structures in all —
...
muscles and 425 of the 457 structures — see "Image and hotspot status" below. The live figures
...
1. **32 of the 457 structures have no locate question.** Every muscle now has one; what is
