...
On first run you'll get a large, immediately-usable content library: 464 structures in all —
...
muscles and 434 of the 464 structures — see "Image and hotspot status" below. The live figures
...
1. **32 of the 464 structures have no locate question.** Every muscle now has one; what is
